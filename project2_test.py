...
test_transform = transforms.Compose(
    [transforms.Resize((300,400)),  #resize the original image to 300x400
     transforms.CenterCrop(224),   #then crop the centre of resized images with size 224x224
     transforms.ToTensor(), 
     transforms.Normalize((0.485,0.456,0.406), (0.229,0.224,0.225)) #Normalization parameters of VGG16 pretrained network
     ])
...
#set batch size is 4 and no change to other hyperparameters.
